    ...
    <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-bold mb-6">
          Naveena's Triumph: From Postal Department to Entrepreneurial Success
        </h1>

        <p className="mb-4">
          Naveena, a young woman from Hyderabad, India, had always faced
          economic challenges. Her family's income was modest, and her limited
          education made it difficult to secure a stable job. Despite these
          obstacles, Naveena was determined to improve her life and contribute
          to her community.{" "}
        </p>
        ...
        <p className="mb-4">
          ...
          training, skill development, and financial literacy. Naveena enrolled
          in a business management course, hoping to acquire the skills needed
          to start her own venture.{" "}
        </p>

        <p className="mb-4">
          With the support of the project's dedicated mentors and instructors,
          Naveena excelled in her studies. She quickly grasped the business
        ...
        <p className="mb-4">
          After completing the course, Naveena was inspired to start her own
          small business. With the financial assistance and guidance provided by
          the Hope Project, she opened a neighborhood grocery store. Her
          business, initially small, quickly gained popularity due to Naveena's
          excellent customer service and competitive pricing.
        </p>

        <p className="mb-4">
          As her business grew, Naveena realized that she needed to expand her
        ...
        <p className="mb-4">
          Naveena's success story is a testament to the power of education and
          ...
          investing in her future, Naveena was able to transform her life and
          create opportunities for herself and her family.
        </p>

        <Image
          src="/stories/naveena.jpg"
          alt="Saritha"
          width={400}
          height={400}
