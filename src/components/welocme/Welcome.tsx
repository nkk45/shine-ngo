    ...
    <>
      <section className="w-full py-20 bg-white relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                ...
                <p className="text-sm font-semibold">5,00,000+ Women Empowered</p>
              </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                ...
                <p className="text-sm font-semibold">PMGDISHA – Digital India</p>
              </div>

              <div className="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                <HeartHandshake className="text-orange-600" />
                <p className="text-sm font-semibold">SHINE ULTRA Menstrual Health</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-5 mt-24 text-center">
          <h2 className="text-3xl font-bold text-gray-900">Join Us in Creating Change</h2>
